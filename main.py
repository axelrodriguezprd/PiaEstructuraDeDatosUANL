...
class Student:
    def __init__(self, ventana):
        ...
        add_btn.grid(row=0, column=0, padx=20, pady=0)

        update_btn=Button(btn_frame, text="Actualizar", width=7, command=self.update_data)
        update_btn.grid(row=0, column=1, padx=20, pady=0)

        delete_btn=Button(btn_frame, text="Borrar", width=7, command=self.delete_data)
        delete_btn.grid(row=0, column=2, padx=20, pady=0)
